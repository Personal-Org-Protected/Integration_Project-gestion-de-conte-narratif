...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230311100232_NewUpdates1_6")]
    partial class NewUpdates1_6
    {
            ...
            modelBuilder.Entity("Domain.Entities.BasketItems", b =>
                {
                    ...
                    b.Property<int>("StoryTellingIdStoryTelling")
                        .HasColumnType("int");

                    b.HasKey("item_id", "basket_id");

                    b.HasIndex("StoryTellingIdStoryTelling");
            ...
            modelBuilder.Entity("Domain.Entities.BasketItems", b =>
                {
                    b.HasOne("Domain.Entities.StoryTelling", "StoryTelling")
                        .WithMany("Items")
                        .HasForeignKey("StoryTellingIdStoryTelling")
