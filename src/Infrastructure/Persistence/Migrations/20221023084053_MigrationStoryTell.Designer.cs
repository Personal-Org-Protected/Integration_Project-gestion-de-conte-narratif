...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221023084053_MigrationStoryTell")]
    partial class MigrationStoryTell
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Library_stories", b =>
                {
                    b.Property<int>("IdStoryTellBox")
                        .HasColumnType("int");

                    b.Property<string>("IdLibrary")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("IdStoryTellBox", "IdLibrary");

                    b.HasIndex("IdLibrary");

                    b.ToTable("Library_BoxStories", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.StoryTellBox", b =>
                {
                    ...
                    b.ToTable("Box de Bibliotheque", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<int>("IdForfait")
                        .HasColumnType("int")
                        .HasColumnName("Forfait reference");
            ...
            modelBuilder.Entity("Domain.Entities.Library_stories", b =>
                {
                    b.HasOne("Domain.Entities.Library", "Library")
                        .WithMany("StoryTellLibrary")
                        .HasForeignKey("IdLibrary")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.StoryTellBox", "StoryTellBox")
                        .WithMany("StoryTellLibrary")
                        .HasForeignKey("IdStoryTellBox")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.UserEntity", b =>
                {
                    b.HasOne("Domain.Entities.ForfaitClient", "ForfaitClient")
                        .WithOne("UserEntity")
                        .HasForeignKey("Domain.Entities.UserEntity", "IdForfait")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
